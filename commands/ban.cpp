...
/*
    ...
    Tasks:
        ...
        2) Verify that the user is not banning themselves.
        ...
        8) Verify that the executor has the BAN_MEMBERS permission.
        9) Get target and executor highest role positions to verify if the ban would normally be possible.
        10) Get bot's permissions and verify that FSB has the BAN_MEMBERS permission.
        11) Verify that FSB roles are high enough to be able to ban the member.
        12) Set the reason.
        13) Try to ban the member from the server.
